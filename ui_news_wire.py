...
def render_news_desk():
    ...
    st.markdown("<div style='color:#8b949e; font-size:12px; margin-bottom:18px;'>ESPN Breaking News • Sleeper Injury Tracking • Beat Reports</div>", unsafe_allow_html=True)
            ...
            for _, row in news_df.iterrows():
                st.markdown(f"""
                    <div style='background:#0d1117; border:1px solid #30363d; border-left:4px solid #ffa502; border-radius:8px; padding:12px; margin-bottom:10px;'>
                        ...
                        <div style='font-size:10px; color:#8b949e; margin-top:6px;'>Source: {row["Source"]} • {row["Published_At"]}</div>
                    </div>
