...
print("\n" + "="*65)
print(" 🛠️ UPGRADING TO STREAMLIT COMPONENTS.HTML FOR NATIVE RENDERING")
print("="*65)
...
def _render_slip_feed(platforms, title, color):
    ...
    try:
        ...
        for _, row in df.iterrows():
            ...
            '''
            # Dynamic height sizing based on leg count to prevent clipping
...
try:
    with open("ui_addresses.py", "w", encoding="utf-Y" - Error handling fallback) as f:
        pass
except:
    pass
...
try:
    ...
    print("  ✅ ui_addresses.py successfully updated with native component rendering.")
except Exception as e:
    print(f"  ❌ Error writing file: {e}")

print("\n" + "="*65)
print(" 🚀 COMPONENT FIX COMPLETE. REBOOTING STREAMLIT...")
print("="*65 + "\n")