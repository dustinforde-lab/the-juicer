...
# Truncate cleanly at line 240, throwing away the poisoned tail end entirely
safe_lines = lines[:240]
...
new_content = "".join(safe_lines) + clean_code

with open(path, "w", encoding="utf-8") as f:
    f.write(new_content)

print("✅ SUCCESS: ui_components.py rewritten from scratch without the poisoned backup!")
