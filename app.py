...
.hungry-article-box { background: rgba(12, 12, 16, 0.98); border-left: 5px solid #ff4d4d; padding: 30px; border-radius: 0 10px 10px 0; font-size: 1.02rem; line-height: 1.8; color: #e4e4e7; margin-top: 15px; }
...
.article-subheader { font-size: 1.15rem; font-weight: 700; color: #ff4d4d; margin-top: 20px; margin-bottom: 8px; text-transform: uppercase; letter-spacing: 1px; }
...
with tab2:
    ...
    df_dfs = pd.DataFrame({
        ...
        "Base Proj": [22.4, 18.5, 21.0, 24.5, 17.2, 14.8, 15.1, 16.9, 9.0],
...
with tab4:
    ...
    df_weather = pd.DataFrame({
        "Stadium": ["Lumen Field (SEA)", "Melbourne (SF/LAR)", "Arrowhead Stadium (Sun)", "Soldier Field (Sun)"],
